...
_print_app_config := \
    @echo "=============================================="; \
     ...
     echo "P4_IGR_METADATA : $(P4_IGR_METADATA)"; \
     echo "P4_EGR_FILE     : $(P4_EGR_FILE)"; \
     echo "P4_EGR_METADATA : $(P4_EGR_METADATA)"; \
...
_configure_app_src_lib := \
	 ...
	 sed -i 's:<custom-env-setup>:BOARD ?= au55c:' $(APP_PROJ_ROOT)/src/config.mk; \
...
_configure_app_common := \
     ...
     echo "export P4_IGR_METADATA := $(P4_IGR_METADATA)"        >> $(APP_CFG_FILE); \
     echo "export P4_EGR_FILE     := $(P4_EGR_FILE)"            >> $(APP_CFG_FILE); \
     echo "export P4_EGR_METADATA := $(P4_IGR_METADATA)"        >> $(APP_CFG_FILE); \
