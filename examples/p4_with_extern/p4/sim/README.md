...
The input stimulus file set for each testcase includes four files:
...
## Testcases: p4_with_extern

`test-fwd-p0` - The p4_with_extern design includes a single example testcase called
