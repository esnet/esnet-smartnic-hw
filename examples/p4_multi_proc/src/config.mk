...
# Library setup
# ----------------------------------------------------
LIB_NAME := "ESnet SmartNIC P4 Multi-Processor Application Library"
LIB_DESC := "RTL and verification for the SmartNIC p4_multi_proc application design"
