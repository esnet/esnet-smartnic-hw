...
# read design sources
source ../../../.out/${board}/[file tail $env(XILINX_VIVADO)]/smartnic/build/synth/sources.tcl
read_checkpoint -cell box_322mhz_inst/smartnic/smartnic_app $env(APP_ROOT)/app_if/smartnic_app.dcp

# read constraints
source ../../../.out/${board}/[file tail $env(XILINX_VIVADO)]/smartnic/build/synth/constraints.tcl
