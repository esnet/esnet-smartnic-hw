...
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__adap_tx*tx"]
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__adap_rx*rx"]

# SLR2
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__adap_tx*rx"]
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__adap_rx*tx"]
