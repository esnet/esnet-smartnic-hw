...
class Header : public NamedP4Object {
 ...
 public:
  ...
  //! Returns true if this header represents scalars
  bool is_scalars() const {
    return scalars;
  }
  ...
  const std::string get_field_full_name(const Field &field) const;
