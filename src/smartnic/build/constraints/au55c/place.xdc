...
resize_pblock       pblock_smartnic_platform -add {CLOCKREGION_X2Y4:CLOCKREGION_X7Y7}
...
resize_pblock       pblock_smartnic_platform_to_app_if -add {CLOCKREGION_X3Y7:CLOCKREGION_X6Y7}
...
resize_pblock       pblock_smartnic_app_to_platform_if -add {CLOCKREGION_X3Y8:CLOCKREGION_X6Y8}
...
add_cells_to_pblock  pblock_slr_2_to_1 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_0*tx"]
...
add_cells_to_pblock  pblock_slr_1_to_2 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_0*rx"]
resize_pblock        pblock_slr_1_to_2 -add {CLOCKREGION_X0Y6:CLOCKREGION_X3Y7}
...
resize_pblock        pblock_slr_1_to_0 -add {CLOCKREGION_X0Y4:CLOCKREGION_X3Y5}
...
create_pblock        pblock_slr_1_to_0_axi4l
add_cells_to_pblock  pblock_slr_1_to_0_axi4l [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__fwd*tx"]
add_cells_to_pblock  pblock_slr_1_to_0_axi4l [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__rev*rx"]
resize_pblock        pblock_slr_1_to_0_axi4l -add {CLOCKREGION_X0Y4:CLOCKREGION_X3Y4}
resize_pblock        pblock_slr_1_to_0_axi4l -add {CLOCKREGION_X2Y5:CLOCKREGION_X3Y5}
set_property IS_SOFT FALSE [get_pblocks pblock_slr_1_to_0_axi4l]

create_pblock        pblock_slr_0_to_1_axi4l
add_cells_to_pblock  pblock_slr_0_to_1_axi4l [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__fwd*rx"]
add_cells_to_pblock  pblock_slr_0_to_1_axi4l [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__rev*tx"]
resize_pblock        pblock_slr_0_to_1_axi4l -add {CLOCKREGION_X0Y2:CLOCKREGION_X1Y2}
resize_pblock        pblock_slr_0_to_1_axi4l -add {CLOCKREGION_X0Y3:CLOCKREGION_X3Y3}
set_property IS_SOFT FALSE [get_pblocks pblock_slr_0_to_1_axi4l]
