...
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_0*rx"]
...
set_property USER_SLR_ASSIGNMENT SLR2 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_0*tx"]

# Smartnic platform-to-qs interfaces
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__fwd*tx"]
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__rev*rx"]
set_property USER_SLR_ASSIGNMENT SLR1 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_1*tx"]
...
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__fwd*rx"]
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells -hierarchical -filter "NAME=~*axi4l_pipe_slr__to_qs_0*g__rev*tx"]
set_property USER_SLR_ASSIGNMENT SLR0 [get_cells -hierarchical -filter "NAME=~*axi4s_pipe_slr__app_to_qs_1*rx"]
