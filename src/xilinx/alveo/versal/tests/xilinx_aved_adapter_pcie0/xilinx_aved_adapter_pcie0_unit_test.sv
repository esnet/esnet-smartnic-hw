...
module xilinx_aved_adapter_pcie0_unit_test;
    import svunit_pkg::svunit_testcase;
    import axi4_verif_pkg::*;
    import axi4_pkg::*;
    import axi4l_pkg::*;

    string name = "xilinx_aved_adapter_pcie0_ut";
    ...
    xilinx_aved_adapter DUT_adapter (
        ...
        .pcie_rstn                ( pcie_rstn                       ),
        .resetn_pcie0             (                                  ),
        // PCIE1 management AXI4-Lite — not exercised
        .m_axi_usr_mgmt_awaddr    ( '0 ),
        .m_axi_usr_mgmt_awprot    ( '0 ),
        .m_axi_usr_mgmt_awvalid   ( '0 ),
        .m_axi_usr_mgmt_awready   (    ),
        .m_axi_usr_mgmt_wdata     ( '0 ),
        .m_axi_usr_mgmt_wstrb     ( '0 ),
        .m_axi_usr_mgmt_wvalid    ( '0 ),
        .m_axi_usr_mgmt_wready    (    ),
        .m_axi_usr_mgmt_bresp     (    ),
        .m_axi_usr_mgmt_bvalid    (    ),
        .m_axi_usr_mgmt_bready    ( '0 ),
        .m_axi_usr_mgmt_araddr    ( '0 ),
        .m_axi_usr_mgmt_arprot    ( '0 ),
        .m_axi_usr_mgmt_arvalid   ( '0 ),
        .m_axi_usr_mgmt_arready   (    ),
        .m_axi_usr_mgmt_rdata     (    ),
        .m_axi_usr_mgmt_rresp     (    ),
        .m_axi_usr_mgmt_rvalid    (    ),
        .m_axi_usr_mgmt_rready    ( '0 ),
